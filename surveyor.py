...
def setup_product_args(product_str:str, creds_file:Optional[str] = None, 
                       profile:Optional[str] = 'default', cbr_sensor_group:Optional[str]=None,
                       cbr_token:Optional[str] = None, cbr_url:Optional[str] = None,
                       cbc_device_group:Optional[str] = None, cbc_device_policy:Optional[str] = None,
                       cbc_token:Optional[str] = None, cbc_url:Optional[str] = None, cbc_org_key:Optional[str] = None,
                       cortex_tenant_ids:Optional[List[int]] = None, 
                       cortex_api_key:Optional[str] = None, cortex_api_key_id:Optional[str] = None,
                       cortex_api_url:Optional[str] = None, cortex_auth_type:Optional[str] = None,
                       dfe_token:Optional[str] = None, dfe_tenantId:Optional[str] = None,
                       dfe_appId:Optional[str] = None, dfe_appSecret:Optional[str] = None,
                       s1_site_ids:Optional[List[str]] = None, s1_account_ids:Optional[List[str]] = None, 
                       s1_account_names:Optional[List[str]] = None, s1_token:Optional[str] = None, 
                       s1_use_powerquery:bool=True) -> dict:
    ...
    match product_str:
        ...
        case 's1':
            ...
            if not any([args.get('site_ids'), args.get('account_ids'), args.get('account_names')]):
...
def survey(product_args: dict, prefix: Optional[str] = None, 
    ...
    if product_args.get('product') is None:
        raise Exception("product argument is required. Be sure to use setup_product_args() to set up the product arguments")
    else:
        product_str = product_args['product']
        del product_args['product'] # remove product key from product_args after setting product_str
    ...
    if len(product_args) > 0 and isinstance(product_args, dict):
        kwargs = product_args
    ...
    try:
        ...
        if len(sigma_rules) > 0:
            pq_check = True if 'pq' in product_args and product_args['pq'] else False
